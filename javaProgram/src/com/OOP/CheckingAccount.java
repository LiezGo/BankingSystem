...
// The CheckingAccount class extends the Account class and adds an attribute which is the overdraftLimit
public class CheckingAccount extends Account{
	private double overdraftLimit; // Maximum amount of money that a customer is allowed to withdraw from their account beyond the available balance
	...
	public void withdraw(double amount) {
		...
		if (amount <= getBalance() + overdraftLimit) {
			setBalance(getBalance() - amount); // Deduct the amount from the balance and set a new balance
