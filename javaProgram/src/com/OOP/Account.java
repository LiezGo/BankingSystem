...
// The Account class represents a bank account, encapsulating details such as accountNumber, balance, and the associated customer.
public class Account {
	...
	public Account(Customer customer, int accountNumber, double balance) {
		...
		this.accountNumber = accountNumber; // Set the accountNumber
